        ...
        <div class="panel-body">
            ...
            <c:if test="${not empty userList}">
                ...
                <form action="searchUser">
                    <div class="row">
                        <div class="col-md-6"><div class="col-md-6">Search User:</div><div class="col-md-6"> <input type="text" name="searchName" id="searchName"> </div></div>
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <c:forEach items="${userList}" var="usr">
                        <tr>
                            ...
                            <th><c:out value="${usr.createDate}"/></th>
